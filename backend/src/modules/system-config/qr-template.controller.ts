...
export class QrTemplateController {
  ...
  @Roles("MANAGER")
  @Get()
  async getQrTemplate(@Req() req: Request): Promise<VehicleQrTemplateConfig> {
  ...
  @Roles("MANAGER")
  @Put()
  async setQrTemplate(@Body() cfg: VehicleQrTemplateConfig, @Req() req: Request): Promise<VehicleQrTemplateConfig> {
